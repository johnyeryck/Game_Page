...
function Main (){
    ...
    const [dados , setDados ] = useState<DataGames[]>()
            useEffect(()=>{
            ...
            autoplay={{  
                ...
                {Games.map((img,i)=>(
                    <SwiperSlide className='transform transition-all   mt-14 mb-10' key={i} >
                            ...
                            <button className=' font-bold  cursor-pointer absolute bottom-4 left-1/4 transform -translate-x-1/2 bg-white px-6 py-2 rounded-2xl hover:bg-purple-600 hover:text-white transition-colors duration-300 ' onClick={teste}>Comprar Agora</button>
                    </SwiperSlide>
