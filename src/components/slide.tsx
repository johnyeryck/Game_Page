    ...
    <main className="mb-52">
      ...
      >
        {gamesApi.map((img, i) => {
          return (
            <SwiperSlide
              className="mt-14 mb-10 border"
              key={i}
            >
              <div className="border-2 shadow-2xl  shadow-purple-300 border-purple-600 w-2/3 ml-auto mr-auto rounded-xl hover:brightness-90 relative ">
                <img
                  src={img.img}
